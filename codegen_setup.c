...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Azure Dreams",
    .project_root_env = "AZURE_DREAMS_PROJECT_ROOT",
    .build_dir_env = "AZURE_DREAMS_BUILD_DIR",
    .force_setup_env = "AZURE_DREAMS_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_006.14_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Azure_Dreams",
    .prepare_note =
